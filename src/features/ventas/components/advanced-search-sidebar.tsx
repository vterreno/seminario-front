...
export function AdvancedSearchSidebar({ 
    ...
    const toggleMetodoPago = useCallback(() => handleFilterToggle('metodo_pago'), [handleFilterToggle])
    ...
    const applyFilters = () => {
        ...
        if (activeFilters.metodo_pago && filters.metodo_pago) {
            activeFiltersOnly.metodo_pago = filters.metodo_pago
        }
                ...
                <ScrollArea className="flex-1 overflow-auto">
                    <div className="space-y-6 px-6 py-6">
                        ...
                        <FilterSection 
                            ...
                            isActive={activeFilters.metodo_pago}
                        ...
                        >
                            <div className="space-y-2">
                                ...
                                <Select
                                    ...
                                    onValueChange={(value) => 
                                        handleFilterChange('metodo_pago', value === '' ? undefined : value)
                                    }
                                    disabled={!activeFilters.metodo_pago}
                                >
                                    <SelectTrigger className='w-full'>
